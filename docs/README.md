...
- [Implementation log](IMPLEMENTATION-LOG.md) — what was built and the decisions
  taken along the way.
- [Self-coordination — how Founder Console manages its own development](architecture/self-coordination.md)
- [Organizational Primitives v0.1](architecture/organizational-primitives-v0.1.md) —
  Architecture Sprint 1 working paper (ratified — see ADR 0006).
- Architecture decision records:
  ...
  - [0006 — Canonical organizational primitives](adr/0006-canonical-primitives.md)
