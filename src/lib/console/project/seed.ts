  ...
  return {
    ...
    milestones: [
      ...
      },
      {
        ...
        items: [
          { id: "it-engine", title: "Project State Engine (single source of truth + derivations)", owner: "Chief Systems Architect", status: "in-progress", eta: "today" },
          { id: "it-office", title: "Executive Office home screen (all panels engine-fed)", owner: "Chief Product Architect", status: "in-progress", eta: "today" },
          { id: "it-session", title: "Begin Session workflow", owner: "Executive Assistant", status: "in-progress", eta: "today" },
          { id: "it-docs", title: "Self-coordination documentation", owner: "Executive Office", status: "planned", eta: "today" },
        ],
        priority: 1,
      },
      {
    ...
    engineering: {
      ...
      buildStatus: "passing",
      tests: { total: 76, passing: 76 },
      latestMilestone: "M2 — Executive Coordination Engine",
      latestAdr: "ADR 0006 — Canonical organizational primitives",
      openPullRequest: "#14 — Executive Office v0.1 + ADR 0006",
    },
